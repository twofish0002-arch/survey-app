...
# ='============================================================================
# 1. PRESENTATION LAYER (HTML TEMPLATE - with strengthened CSS grid)
# ==============================================================================
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        ...
        html, body {
            height: 100%; /* Ensure body can be a full-height container */
            margin: 0;
            padding: 0;
        }
        body{
            ...
            align-items: flex-start; /* Aligns grid to the top */
        }
        
        .dashboard-grid{
            display: grid;
            grid-template-columns: 1fr 2fr; /* Explicit 1/3 and 2/3 column sizing */
            gap: 24px;
            width: 100%;
            max-width: 1600px;
        }
        ...
        .card-header{font-size:1.1rem;font-weight:600;color:#1a20c;margin-top:0;margin-bottom:16px;border-bottom:1px solid #e2e8f0;padding-bottom:12px;}
        .archetype-card{border-top:5px solid var(--accent-color);text-align:center;padding-top:32px;}
        .archetype-card h2{margin:0;font-size:2rem;color:#1a20c;}
        ...
        .kpi-card .value{font-size:2.5rem;font-weight:700;color:#1a20c;line-height:1;}
...
def index():
    ...
    fig.update_layout(
        title=dict(text=initial_title,y=0.98,x=0.5,xanchor='center',yanchor='top',font=dict(size=22,color='#2c3e50')),
        paper_bgcolor='white', plot_bgcolor='white', showlegend=False,
        scene=dict(xaxis={**axis_style, 'title': 'Control'}, yaxis={**axis_style, 'title': 'Attention'}, zaxis={**axis_style, 'title': 'Information'}, camera=dict(eye=dict(x=1.5,y=-1.5,z=1.3)), aspectmode='cube'),
