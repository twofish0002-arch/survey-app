...
# ==============================================================================
# 1. PRESENTATION LAYER (HTML TEMPLATE - with new warning element and logic)
# ==============================================================================
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="dashboard-grid">
        <div class="left-column">
            ...
            <!-- NEW WARNING BOX HTML -->
            <div class="pupil-warning" id="pupil-warning-message" style="display: {% if k_band == 0 %}block{% else %}none{% endif %};">
                <strong>Warning:</strong> There is a threat in the environment. All players must do exactly as instructed. Stay with the group.
            </div>
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            ...
            const warningMessage = document.getElementById('pupil-warning-message'); // Get the warning element
            ...
            archetypeSlider.addEventListener('input', function(event) {
                ...
                // Show warning only if slider is on the first step (Pupil)
                if (kValue === 0) {
